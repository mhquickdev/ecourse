...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        ...
        {{-- Add Student button if applicable --}}
    </div>
    ...
    {{-- Search form --}}
    <div class="mb-6">
        <form action="{{ route('admin.users.students.index') }}" method="GET">
            <div class="flex items-center border border-gray-300 rounded-lg shadow-sm overflow-hidden">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search students..." class="flex-1 px-4 py-2 focus:outline-none focus:ring-0 border-none">
