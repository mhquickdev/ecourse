...
<div class="flex min-h-screen">
    ...
    <!-- Right Section (Mentor Register Form) -->
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-10">
        <div class="w-full max-w-md">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-[#2D2363]">Mentor Sign Up</h1>
            </div>
            ...
            <div class="flex flex-col items-center mt-6 gap-2">
                <a href="{{ route('register') }}" class="w-full bg-[#2D2363] text-white font-semibold rounded-full px-8 py-3 text-base shadow hover:bg-[#1a153a] transition text-center">Register as Student</a>
                <div class="text-center text-sm text-gray-600">
                    Already have an account? <a href="{{ route('login') }}" class="underline text-[#F85A7E] hover:text-[#e13a5e]">Login</a>
                </div>
            </div>
        </div>
    </div>
